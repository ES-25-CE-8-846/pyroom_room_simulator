...
class DatasetGenerator:
    ...
    def parse_params(self, **kwargs):
        ...
        self.splits: dict = kwargs.get("splits", {
            "train": {"num_rooms": 1, "num_phone_pos": 1,},
            "val": {"num_rooms": 1, "num_phone_pos": 1,}, 
            "test": {"num_rooms": 1, "num_phone_pos": 1, },
        })
        ...
        self.room_params: dict = kwargs.get("room_params", {"fs": None,"n_mics": None,"mic_radius": None, "shape": "shoebox", "signal": None,})
    ...
    def start(self):
        ...
        for split, params in self.splits.items():
            ...
            for i in range(params['num_rooms']):
                ...
                self.simulate_room(self.room_params, num_phone_pos=params['num_phone_pos'], save_dir=save_dir, dtype=self.dtype, plot=False, seed=self.seed)
                logger.warning(f"Successfully generated room {i+1}/{params['num_rooms']}!")
